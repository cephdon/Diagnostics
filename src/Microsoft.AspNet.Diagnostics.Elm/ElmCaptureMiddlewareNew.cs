...
namespace Microsoft.AspNet.Diagnostics.Elm
{
    ...
    /// </summary>
    public class ElmCaptureMiddlewareNew
    {
        private readonly RequestDelegate _next;
        private readonly ElmOptions _options;
        private readonly ILogger _logger;

        public ElmCaptureMiddlewareNew(RequestDelegate next, ILoggerFactory factory, IOptions<ElmOptions> options)
        {
            _next = next;
        ...
        public async Task Invoke(HttpContext context)
        {
            ...
            {
                ElmScopeNew.Current.Context.HttpInfo = GetHttpInfo(context, requestId);
                try
                {
                    await _next(context);
                }
                ...
                {
                    ElmScopeNew.Current.Context.HttpInfo.StatusCode = context.Response.StatusCode;
                }
            }
        }
